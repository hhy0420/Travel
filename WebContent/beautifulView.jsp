...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerView">
            <p><strong>景点id：</strong><span>${bea.bid }</span></p>
            <p><strong>景点名称：</strong><span>${bea.bname }</span></p>
            <p><strong>景点地址：</strong><span>${bea.baddress }</span></p>
            <p><strong>景点门票：</strong><span>${bea.bprice }</span></p>
            <p><strong>景点简介：</strong><span>${bea.bnotes }</span></p>
            <a href="beautifulList.do">返回</a>
        </div>
    </div>
</section>
<footer class="footer">
